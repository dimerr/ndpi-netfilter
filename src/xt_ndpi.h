...
"SAP","GTP","uPnP","LLMNR","Remote_Scan","Spotify","WebM","H323","OpenVPN","NOE","CiscoVPN","Teamspeak","TOR","Skinny","Corba","RTCP",\
...
"sap","gtp","upnp","llmnr","remotescan","spotify","webm","h323","openvpn","noe","ciscovpn","teamspeak","tor","rsync","skinny","rtcp",\
"rsync","oracle","corba","ubuntuone"
#endif
